...
func (s *SlackAPI) PrintChannelsArchive(channel string) {
	response := s.ChannelsArchive(channel)
	s.PrintAndExit(response)
}
...
func (s *SlackAPI) PrintChannelsInvite(channel string, user string) {
	response := s.ChannelsInvite(channel, user)
	s.PrintAndExit(response)
}
...
func (s *SlackAPI) PrintChannelsKick(channel string, user string) {
	response := s.ChannelsKick(channel, user)
	s.PrintAndExit(response)
}
...
func (s *SlackAPI) PrintFilesList(action string, filter string, count string, page string) {
	response := s.FilesList(action, filter, count, page)
	s.PrintAndExit(response)
}
